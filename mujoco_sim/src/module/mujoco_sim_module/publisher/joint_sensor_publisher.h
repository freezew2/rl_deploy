...
class HandSensorPublisher : public JointSensorPublisherBase {
 public:
  HandSensorPublisher() = default;
  ~HandSensorPublisher() override = default;

  void Initialize(YAML::Node options_node) override;
  void PublishSensorData() override;

  std::string_view Type() const noexcept override { return "hand_sensor"; }

 private:
  std::vector<double> state_offset_;
  std::vector<double> state_ratio_;
};
